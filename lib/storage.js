...
/*
 *  Retrieve Values for given custom attribute
 */
exports.retrieveLookup = function(cookies, attrNum, fn) {

	// define variables specific to the API call
	var soapAction = 'RetrieveLookupData'
		, soapRequest = '<repository>NG-3XZLS64F</repository><attrNum>' +
      attrNum + '</attrNum><mode>1</mode><criteria></criteria><parentKey></parentKey><firstItem></firstItem><findDesc>true</findDesc><includeClosed>true</includeClosed><maxRows>40</maxRows>';
